...
export function CurationHeader({
  ...
  return (
    <div className="h-fit w-full flex-row flex-wrap justify-center border-2 border-solid border-red-500">
      ...
      {connectionStatus ? (
        <div className="flex h-full w-full flex-row flex-wrap pl-4 ">
